...
@del /F /S /Q  com
@javac  LogUtil.java  SDKInterface.java  SDKFoundation.java  SDKImpl.java  SDKBase.java  CommonSDK.java  -source 1.6  -target 1.6  -bootclasspath classes.jar   -classpath  android.jar  -d .
